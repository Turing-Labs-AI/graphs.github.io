(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root["cytoscapeSpread"] = factory(root["weaver"]);
              ...
              .run(function (pData) {
                ...
                if (lExpFact < 0.0) {
                  ...
                  lExpFact = Math.max(
                    ...
                    Math.min(
                      0.1,
                      (lMinDist / Math.sqrt((lWidth * lHeight) / fv.length)) *
                        0.5
                    )
                  );
                ...
                while (!bStop) {
                  ...
                  if (currInfractions <= 0) {
                    ...
                    if (
                      currInfractions >= prevInfractions ||
                      voronoiIteration >= 4
                    ) {
...
*/
        ...
        Voronoi.prototype.sqrt = function (n) {
          return Math.sqrt(n);
        };
        Voronoi.prototype.abs = function (n) {
          return Math.abs(n);
        };
        ...
        Voronoi.prototype.Cell.prototype.getNeighborIds = function () {
          ...
          while (iHalfedge--) {
            ...
            if (
              edge.lSite !== null &&
              edge.lSite.voronoiId != this.site.voronoiId
            ) {
        ...
        Voronoi.prototype.setEdgeStartpoint = function (
          edge,
          lSite,
          rSite,
          vertex
        ...
        Voronoi.prototype.setEdgeEndpoint = function (
          edge,
          lSite,
          rSite,
          vertex
...
*/
        ...
        Voronoi.prototype.compute = function (sites, bbox) {
          ...
          if (this.toRecycle) {
            this.vertexJunkyard = this.vertexJunkyard.concat(
              this.toRecycle.vertices
            );
